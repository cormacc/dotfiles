...
values."
  (setq-default
   ...
   '(
     ...
     better-defaults
     ;; TODO: c-c++, mineo-rtags and spacemacs-cmake-ide are all variants of a c layer incorporating cmake-ide -- merge best of all worlds
     ;; when next working in C
...
you should place your code here."
  ...
  ;; C-mode stuff -- move this into private layer?
