...
- [[#future-plans][Future plans]]
  - [[#implement-automatic-direnv][Implement automatic direnv?]]
...
** TODO Implement automatic direnv?
...
#+begin_src shell
  home-manager switch --flake 'path:dotfiles/nix/home#cormacc' --impure -b backup
#+end_src
